      ...
      <ul class="nav">
        <li class="list">
          ...
          <dl>
            ...
            <dd> <nuxt-link to="/s">我的订单</nuxt-link></dd>
            <dd> <nuxt-link to="/d">我的订单</nuxt-link></dd>
          </dl>
        ...
        <li class="list bd">
          ...
          <dl>
            <dd>
              <nuxt-lik to="/loginSjia">登陆商家中心</nuxt-lik>
            </dd>
            <dd>
              <nuxt-lik to="/coop">我想合作</nuxt-lik>
            </dd>
            <dd>
              <nuxt-lik to="/wap">免费手机开店</nuxt-lik>
            </dd>
            <dd>
              <nuxt-lik to="/kaipiao">商家申请开票</nuxt-lik>
            </dd>
          </dl>
        </li>
        <li class="list size">
          <nuxt-link to="/size">网站导航</nuxt-link>
